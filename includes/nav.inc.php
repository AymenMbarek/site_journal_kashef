...
<head>
  ...
  <!-- TITLE OF THE PAGE -->
  <title>Kashef | <?php echo $page_title; ?></title>
...
<body>
  ...
  <!-- ======== NAVBAR ======== -->
  <nav class="navbar">
   <!-- <div class="logo" ><a href="./index.php"><img src="./assets/images/logok.png" /></a></div>
    ...
    <ul class="ul">
      ...
      <li>
        <label for="btn-1" class="show">فئات +</label>
        <a href="./categories.php" <?php if($category) echo 'class="current"' ?>>فئات</a>
        ...
        <ul>
          ...
          ?>
          <li><a href="./categories.php">المزيد +</a></li>
        </ul>
      </li>
      <li><a href="./bookmarks.php" <?php if($bookmark) echo 'class="current"' ?>>إشارات مرجعية</a></li>
      <?php
      ...
      <li>
        ...
        <a href="./user-login.php" <?php if($login) echo 'class="current"' ?>>تسجيل الدخول</a>
        <input type="checkbox" id="btn-2" class="input" />
        <ul>
          <li><a href="./user-login.php">قارئ</a></li>
          <li><a href="./author-login.php">صحفي</a></li>
        </ul>
      </li>
      <li><a href="./index.php" <?php if($home) echo 'class="current"' ?>>الصفحة الرئيسية</a></li>
      <?php
        }
      ?>
